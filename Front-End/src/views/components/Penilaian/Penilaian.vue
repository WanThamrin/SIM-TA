      ...
      <div class="col-12">
        <div class="card my-4">
          <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
            ...
            >
              <h6 class="text-white text-capitalize ps-3">Data Mahasiswa Seminar Hasil</h6>
            </div>
          </div>
                  ...
                  <tr>
                    ...
                    <td class="align-middle text-center text-sm">
                      <span class="text-sm font-weight-bold"
                        >Sisca Sabyan S.Kom M.Kom</span
                      >
                    </td>
                    <td class="align-middle text-center">
                      <span class="text-secondary text-sm font-weight-bold"
                        >John Michael S.Kom M.Kom</span
                      >
                    </td>
                    <td class="align-middle text-center">
                      <span class="text-secondary text-sm font-weight-bold"
                    ...
                    <td class="align-middle text-center">
                      <span class="text-secondary text-sm font-weight-medium"
                        >21/06/2020 (13.00-16.00)</span
                      >
                    </td>
                    <td class="align-item-center">
                      <a class="btn btn-link text-dark mb-0 px-0 ms-4" href="javascript:;">
                        <router-link 
                        :to="{name:'Nilai'}"
                        ><i class="fas fa-duotone fa-hashtag text-success me-0 fa-lg me-2" aria-hidden="true"></i>NILAI
                      </router-link>
                      </a>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td class="align-item-center">
                      <a class="btn btn-link text-dark mb-0 px-0 ms-4" href="javascript:;">
                        <router-link 
                        :to="{name:'Nilai'}"
                        ><i class="fas fa-duotone fa-hashtag text-primary me-0 fa-lg me-2" aria-hidden="true"></i>NILAI
                      </router-link>
                    </a>
                    </td>
                  </tr>

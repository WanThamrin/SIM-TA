      ...
      <div class="col-xxl-12">
        <div class="card card-body mx-3 mx-md-4 mt-n6">
          <div class="card-header align-items-center d-flex">
            <h4 class="card-title mb-0 flex-grow-1">Daftar Dokumen Sidang</h4>
          </div>
          <!-- end card header -->
          <div class="card-body">
            <p class="text-muted">Form Daftar Dokumen Sidang</p>
            <div class="live-preview">
              <form @submit.prevent="update()">
                <div class="row mb-3 ">
                  <div class="col-lg-3 my-2">
                    <label for="nameInput" class="form-label">Judul Dokumen Sidang</label>
                  </div>
                  <div class="col-lg-9 my-1">
                    <input id="judul" type="text" placeholder="Masukkan Judul Pengumuman"
                      ...
                      :isRequired="true" v-model="DocSemhas.judul" /> {{}}
...
export default {
  ...
  methods: {
    ...
    update() {
      ...
      axios.post(
        'http://127.0.0.1:8000/api/doc-semhas/' + this.$route.params.id +'?_method=put',

                ...
                <div class="row mb-3 ">
                  ...
                  <div class="col-lg-9 my-1">
                    <input id="judul" type="text" placeholder="Masukkan Judul Pengumuman"
                      ...
                      :isRequired="true" v-model="DocSempro.judul" /> {{}}
...
export default {
  ...
  methods: {
    getInfo() {
      axios.get(
        'http://127.0.0.1:8000/api/doc-sempro/' + this.$route.params.id,
      )
        .then((result) => {
          this.DocSempro = result.data.data
    ...
    update() {
      ...
      axios.post(
        'http://127.0.0.1:8000/api/doc-sempro/' + this.$route.params.id +'?_method=put',

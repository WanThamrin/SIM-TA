      ...
      <div class="col-xxl-12">
        <div class="card card-body mx-3 mx-md-4 mt-n6">
          <div class="card-header align-items-center d-flex">
            <h4 class="card-title mb-0 flex-grow-1">Data Jadwal Seminar Proposal</h4>
          </div>
          <!-- end card header -->
          <div class="card-body">
            <p class="text-muted">Data Jadwal Seminar Proposal</p>
            <div class="live-preview">
              <form @submit.prevent="">
                ...
                <div class="row mb-3">
                  <div class="col-lg-3 my-2">
                    <label for="nameInput" class="form-label">Dosen Peguji I</label>
                  </div>
                  <div class="col-lg-9 my-1">
                    <h6 class="mb-0 text-md  my-1">{{Sempro.t_a.dosen3.name}}</h6>
                  </div>
                </div>
                <div class="row mb-3">
                  <div class="col-lg-3 my-2">
                    <label for="nameInput" class="form-label">Dosen Peguji II</label>
                  </div>
                  <div class="col-lg-9 my-1">
                    <h6 class="mb-0 text-md  my-1">{{Sempro.t_a.dosen4.name}}</h6>
                  </div>
                </div>
                <div class="row justify-content-evenly mb-3">
                  ...
                  <div class="col-lg my-1">
                    <h6 class="mb-0 text-md  my-1">{{Sempro.user.jadwal_sempro.hari}}</h6>
                  </div>
                  <div class="col-lg my-2">
                    <label for="nameInput" class="form-label text-danger">Jam Mulai</label>
                  </div>
                  <div class="col-lg my-1">
                    <h6 class="mb-0 text-md  my-1">{{Sempro.user.jadwal_sempro.jam_mulai}}</h6>
                  </div>
                  <div class="col-lg my-2">
                    <label for="nameInput" class="form-label text-danger">Jam Akhir</label>
                  </div>
                  <div class="col-lg my-1">
                    <h6 class="mb-0 text-md  my-1">{{Sempro.user.jadwal_sempro.jam_akhir}}</h6>
                  </div>
                </div>
                <div class="row mb-3">
                  <div class="col-lg-3 my-2">
                  ...
                  <div class="col-lg-8 my-2">
                    <h6 class="mb-0 text-md  my-1">{{Sempro.user.jadwal_sempro.type}}</h6>
                  </div>
                </div>
                <div class="row mb-3">
                  <div class="col-lg-3 my-2">
                  ...
                  <div class="col-lg-9 my-2">
                    <h6 class="mb-0 text-md  my-1">{{Sempro.user.jadwal_sempro.ruangan}}</h6>
                  </div>
                </div>
              </form>
            </div>

                            ...
                            <table class="table align-items-center mb-0">
                                ...
                                <tbody>
                                    <tr v-for="(dosen, index) in dosens" :key="index">
                                        ...
                                        <td class="align-middle text-center">
                                            <span v-for="(bimbingan, key) in dosen.bimbingan" :key="key"
                                                class="text-sm font-weight-medium">{{ bimbingan.mata_kuliah
                                                }}<br></span>
                                        </td>
                                        ...
                                        <td class="align-middle text-center">
                                            <span v-for="(riset, idx) in dosen.riset" :key="idx"
                                                class="text-secondary text-sm font-weight-medium">{{ riset.nama_riset
                                                }}<br></span>
                                        </td>
                                        <td class="align-middle">
                                            <a class="btn btn-link text-dark mb-0 px-0" href="javascript:;">
                                                <router-link :to="{ name: 'Detail-Dosen', params: { id: dosen.id } }"><i
                                ...
                                <div class="card ">
                                    <div class="card-header pb-0 p-3">
                                        <div class="row">
                                            ...
                                            <div class="col-2">
                                                <router-link :to="{ name: 'Matkul' }"
                                                    class="btn btn-dark my-0 me-4 py-1 px-2" type="button">
                                            ...
                                            <li v-for="(bebanBimbingan, index) in bebanBimbingans.data" :key="index"
                                                ...
                                                <div ms-auto text-end>
                                                    <a class="btn btn-link text-dark px-1 mb-0" href="javascript:;">
                                                        <router-link
                                                            :to="{ name: 'Edit-Matkul', params: { id: bebanBimbingan.id } }">
                                                            <i class="fas fa-pencil-alt text-dark me-0 fa-lg"
                                                                aria-hidden="true"></i>
                                                        </router-link>
                                                    </a>
                                    ...
                                    <ul class="list-group" v-for="(Riset, index) in Risets.data" :key="index">
                                        <li class="list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg"
                                            ...
                                            <div class="d-flex flex-column">
                                                ...
                                                <span class="mb-2 text-md">
                                                    Keyword:
                                                    <span class="text-dark ms-sm-2 font-weight-bold">{{ Riset.keyword
                                                    }}</span>
                                                </span>
                                                <span class="text-md">
                                                    Note:
                                                    <span class="text-dark ms-sm-2 font-weight-bold">{{ Riset.note
                                                    }}</span>
                                                </span>
                                            </div>
                                            <div class="ms-auto text-end">
                                                ...
                                                <a class="btn btn-link text-danger text-gradient px-3 mb-0"
                                                    href="javascript:" @click.prevent="drop(Riset.id)">
                                                    <i class="far fa-trash-alt me-0 fa-lg" aria-hidden="true"></i>
                                                </a>
                            ...
                            <table class="table align-items-center mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr v-for="(RegisTA, index) in RegisTAs.dospem1" :key="index">
                                        ...
                                        <td class="align-middle text-center ">
                                            <a class="btn btn-sm bg-gradient-success  mb-0 me-2" href="javascript:;"
                                                @click="updateStatus(RegisTA.id, 1)">Terima
                                            </a>
                                            <a class="btn btn-sm bg-gradient-danger  mb-0 me-2" href="javascript:;"
                                                @click="updateStatus(RegisTA.id, 2)">Tolak
                                            </a>
                                        </td>
                                    ...
                                    <tr v-for="(RegisTA, index) in RegisTAs.dospem2" :key="index">
                                        ...
                                        <td class="align-middle text-center ">
                                            <a class="btn btn-sm bg-gradient-success  mb-0 me-2" href="javascript:;"
                                                @click="updateStatus2(RegisTA.id, 1)">Terima
                                            </a>
                                            <a class="btn btn-sm bg-gradient-danger  mb-0 me-2" href="javascript:;"
                                                @click="updateStatus2(RegisTA.id, 2)">Tolak
                                            </a>
                                        </td>
                                        <!-- <td class="align-middle text-center">
        ...
        <div class="mx-auto mt-3 col-lg-4 col-md-6 my-sm-auto ms-sm-auto me-sm-0">
            <div class="nav-wrapper position-relative end-0">
                <ul class="p-1 bg-transparent nav nav-pills nav-fill" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="px-0 py-1 mb-0 nav-link" data-bs-toggle="tab" href="#Pendamping" role="tab"
                            aria-selected="false">
                    ...
                    <div class="card-body px-0 pb-2">
                        <div class="table-responsive p-0">
                            <table class="table align-items-center mb-0">
                                ...
                                <tbody>
                                    <tr v-for="(Bimbingan, index) in Bimbingans.dospem1" :key="index">
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                <div>
                                                    <img src="@/assets/img/user.jpg"
                                        ...
                                        <td class="align-middle text-center">
                                            <span class="text-sm font-weight-normal">{{ Bimbingan.number }}</span>
                                        </td>
                                        <td class="align-middle text-center">
                    ...
                    <div class="card-body px-0 pb-2">
                        <div class="table-responsive p-0">
                            <table class="table align-items-center mb-0">
                                ...
                                <tbody>
                                    <tr v-for="(Bimbingan, index) in Bimbingans.dospem2" :key="index">
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                <div>
                                                    <img src="@/assets/img/user.jpg"
...
export default {
    ...
    methods: {
            ...
            axios.get('http://127.0.0.1:8000/api/get-dospem',
                ...
                .then((result) => {
                    this.RegisTAs = result.data.data,
                        console.log(this.RegisTAs, 'gettugas')
                }).catch((err) => {
        ...
        getBimbingan() {
            let token = localStorage.getItem("token")
            axios.get('http://127.0.0.1:8000/api/get-bimbingan',
                { headers: { Authorization: `Bearer ${token}` } })
                .then((result) => {
                    this.Bimbingans = result.data.data,
                        console.log(this.Bimbingans)
                }).catch((err) => {
                    console.log(err.response)
